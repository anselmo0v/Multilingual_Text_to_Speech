...
class Params:
    ...
    ******************** PARAMETERS OF AUDIO ********************
    ...
    sample_rate = 24000                  # sample rate of source .wavs, used while computing spectrograms, MFCCs, etc.
    num_fft = 2400                       # number of frequency bins used during computation of spectrograms
